...
//          viewHolder.btn=convertView.findViewById(R.id.btnXoa);
        ...
        Picasso.get().load(truyen.getAnh()).placeholder(R.drawable.ic_edit).error(R.drawable.ic_baseline_image_not_supported_24).into(viewHolder.imgtruyen);
